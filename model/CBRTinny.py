...
class CBRTinny(nn.Module):

    def __init__(self,num_classes=10, init_weights=True, channels=1,drop_rate=0):
        super(CBRTinny, self).__init__()
        ...
        self.ssp = PyramidPooling(levels=[3,2,1])

        n = self.ssp.get_output_size(filters=256)
        #4*4 + 2*2 + 1*1
